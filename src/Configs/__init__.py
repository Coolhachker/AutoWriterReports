...
json_data_to_post_message_into_gigachat = {
    ...
    'messages': [
        {
            'role': 'system',
            'content': """Ты - технический специалист по системному администрированию. Создай краткую подпись к скриншоту лабораторной работы по установке и настройке серверных компонентов (System Center Conf Manager и так далее). 
